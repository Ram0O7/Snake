...
for (const file of ['index.html','styles.css','game.js','engine.js','touch-controls.js','music.js','music.mp3','in-game.mp3','favicon.svg','robots.txt','sitemap.xml','_headers','.nojekyll']) {
